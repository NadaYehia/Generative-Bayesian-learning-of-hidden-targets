function [r,theta,x_op,y_op,exitflag,trials_to_optimize]=trajectory_planner_opt_pl_and_smoothness(r_anchors,theta_anchors,env,Ths,Rs,...
rho,tol_radius,r_home,w1,w2,dt,eps,max_opti_trials)
...
if(rand(1)>0.5)
    phi0_n(1)=S_theta(1)-eps;
else
    phi0_n(1)=(-(pi-S_theta(1)))+eps;
end
...
[~]=optimizer_obj.loss(optimal_para,arena,rho,numel(r0),w1,w2,dt);
