...
% - Lower bound on the first heading vector offset: 
%   phi0_0=-[heading_vector(1)-pi/2] that results in phi(0)=0.
...
% - Upper bound on the first heading vector offset: pi.
%   phi0_0= pi - [ heading_vector(1) - pi/2] that results in phi(0)=pi.

ub(1)=pi -(theta(2)-(pi/2)); 
