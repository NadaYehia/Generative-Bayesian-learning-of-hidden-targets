...
max_radial_distance=839;  %maximum speed value in the action space.
min_radial_distance=0;     % minimum speed value in the action space
...
Rs=linspace(min_radial_distance,max_radial_distance,n);
