...
env.obstacle=[0 0 0 0 phi_obstacle 0 ];
...
%          posterior=new_posterior;
      ...
      %% sampler function for the next actions calling either: proportional or peak sampler
         [r_anchors,omega_anchors,anchors_no(k+1)]= Sampling_next_actions(posterior,sampler,initial_ancs,Rs,Os,merging_criterion,[],percentile_peak_sampler);
      ...
      if(anchors_no(k+1)>1)
       ...
       %% sample and plan the new route from the current active posterior.
         [r_anchors,omega_anchors,anchors_no(k+1)]= Sampling_next_actions(active_prior,sampler,initial_ancs,Rs,Os,merging_criterion,[],percentile_peak_sampler);
