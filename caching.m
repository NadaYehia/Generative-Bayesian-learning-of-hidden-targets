function [posterior,flg,curr_t_lst_caching]=caching(reward_rate, current_posterior,As,Os,arena,clearnce,T,h1,h2,...
    previous_t_lst_caching)
...
% for samples from the start till current trial
