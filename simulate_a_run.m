function [target_hit,hit_time]=simulate_a_run(pos_x,pos_y,target_num,env,hit_time)
    ...
    for t=2:size(pos_x,2)
        ...
        if pos_y(t)>curr_target_centers(2)-(curr_target_dims(2)/2) ...
           & pos_y(t)<curr_target_centers(2)+(curr_target_dims(2)/2) & ... 
             pos_x(t)>curr_target_centers(1)-(curr_target_dims(1)/2) & ...
             pos_x(t)<curr_target_centers(1)+(curr_target_dims(1)/2)
